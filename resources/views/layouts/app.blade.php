    ...
    <header class="style5">
        <div class="menu-sec">
            <div class="container fluid">
                ...
                <div class="logo">
                    <a href="index.html" title=""><img src="{{ asset('images/logo-white.png') }}" alt="" /></a>
                </div><!-- Logo -->
                <div class="btn-extars">
                    <a href="#" title="" class="post-job-btn"><i class="la la-plus"></i>Post Jobs</a>
                    <ul class="account-btns">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 column">
                        <div class="detalbr-mkp">
                            <img src="images/resource/mockup4.png" alt="" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3 column">
                        <div class="widget">
                            <div class="about_widget">
                                <div class="logo">
                                    <a href="#" title=""><img src="{{ asset('images/logo-white.png') }}" alt="" /></a>
                                </div>
                                <span>Collin Street West, Victor 8007, Australia.</span>
                                <span>+1 246-345-0695</span>
                                <span><a href="https://grandetest.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="5d34333b321d37323f35283329733e3230">[email&#160;protected]</a></span>
                                <div class="social">
                    ...
                    <div class="col-lg-3 column">
                        <div class="widget">
                            <div class="download_widget">
                                <a href="#" title=""><img src="images/resource/di.png" alt="" /></a>
                                <a href="#" title=""><img src="images/resource/di2.png" alt="" /></a>
                            </div>
                        </div>
                    </div>
                </div>
